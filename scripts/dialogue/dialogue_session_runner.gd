...
func _init() -> void:
	...
	reveal_controller.bulk_reveal_started.connect(func(start_index: int, end_index: int): bulk_reveal_started.emit(start_index, end_index))
	reveal_controller.bulk_reveal_finished.connect(func(start_index: int, end_index: int): bulk_reveal_finished.emit(start_index, end_index))
